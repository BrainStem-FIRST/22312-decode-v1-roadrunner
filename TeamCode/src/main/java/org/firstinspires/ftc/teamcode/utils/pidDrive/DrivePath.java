...
public class DrivePath implements Command {
    ...
    private PIDController totalDistancePID, waypointDistancePID, headingPID;
    private final ElapsedTime waypointTimer;
    private boolean reachedDestination;

    public DrivePath(Drive drivetrain, PinpointLocalizer odo, Waypoint destination) {
        this(drivetrain, odo, destination, null);
    }
    public DrivePath(Drive drivetrain, PinpointLocalizer odo, Waypoint destination, Telemetry telemetry) {
...
//        }
        ...
        drivetrain.drive(lateralPower, axialPower, headingPower);
    ...
    public void end(boolean interrupted) {
        ...
        telemetry.addData("drive path finished", "yaay");
        telemetry.update();
    }
    @Override
    ...
    private void resetToNewWaypoint() {
        ...
        headingPID = new PIDController(getCurParams().headingKp, getCurParams().headingKi, getCurParams().headingKd);
        headingPID.reset();
