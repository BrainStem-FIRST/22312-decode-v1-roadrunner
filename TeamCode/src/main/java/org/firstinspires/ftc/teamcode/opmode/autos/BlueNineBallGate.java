...
@Autonomous(name = "Blue Nine Ball Gate")
//@Config
public class BlueNineBallGate extends LinearOpMode {
...
// x is -12.6 y is -33.3 heading - 139.9
        ...
        Action driveToShootFirstLine = drive.actionBuilder(atGate)
                .setReversed(true)
                .strafeToLinearHeading(blueDriveToShootingPose.position, Math.toRadians(-155))
                .build();
